...
\usepackage{geometry}
\geometry{left=2.2cm, top=1.6cm, right=2.0cm, bottom=1.8cm, footskip=.4cm}
...
\newcommand{\VoteTable}[1]{{\ctexset{space=true}\mincho\begin{quote}#1\end{quote}}}
